    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "- If the user is asking to filter or browse by known attributes (contractor name, region, province, status, category, year), rewrite it into this template: Filter contracts where [field]=[value] AND [field]=[value]\n"
