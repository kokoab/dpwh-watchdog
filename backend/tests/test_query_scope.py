...
class CompactThreadContextTests(unittest.TestCase):
    def test_compact_thread_context_summarizes_result_and_plan(self) -> None:
        ...
        with (
            patch("query_scope.get_thread_result", return_value=result_state),
            patch("query_scope.get_thread_plan", return_value=plan_state),
        ):
    ...
    def test_compact_thread_context_handles_empty_state(self) -> None:
        with (
            patch("query_scope.get_thread_result", return_value={}),
            patch("query_scope.get_thread_plan", return_value={}),
        ):
